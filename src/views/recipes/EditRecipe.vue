<template>
    <section class="content">
        <div class="container">
            <h1 class="title">Edit Resep Masakan Saya</h1>
            <div class="alert">
            ...
            <form @submit.prevent="saveData">
                ...
                <div class="row">
                    <div class="button-footer col-4 offset-8">
                        <router-link :to="{name: 'myRecipes'}" class="btn batal">Batal</router-link>
        ...
        loadRecipe() {
            if(this.$store.getters.getToken !== '') {
                ...
                headers: {
                    ...
                    this.recipename = data.data[0].recipename;
                    ...
                    this.ingredients = data.data[0].ingredients;
                    this.howtocook = data.data[0].howtocook;
                }).catch(error => {
                    console.log(error);
    ...
    methods: {
        async saveData() {
            if(this.$store.getters.getToken !== '') {
                ...
                const response = await fetch("http://127.0.0.1:8000/api/recipes/update/" + this.id, {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                        "Accept": "application/json",
                ...
                if (!response.ok) {
                    ...
                    this.$router.push({name: 'myRecipes', replace:true, params: {message: "Resep Masakan Berhasil Diubah."}});
                }
...
<style scoped>
@import '../../assets/css/recipes/editRecipe.css';
</style>